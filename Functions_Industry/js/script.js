...
if(hours <= 75){
    ...
    alert("The project will cost an estimated " + normalPrice + " dollars at your normal hourly rate of " + hourlyRate +" dollars per hour.");
}else if(hours > 75){
    ...
    alert("The project will cost an estimated " + discountPrice + " dollars at your discount hourly rate of " + discountHourlyRate +" dollars per hour.");
}
